<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="testimonial.aspx.cs" 
    EnableEventValidation="false" ValidateRequest="false" Inherits="ProjectOne.admin.master.testimonial" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_FormName" runat="server">
    <i class="icon-home2 mr-2"></i>Testimonials Section
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="cph_MainBody" runat="server">
    <div class="content" style="min-height: 10px;">
        ...
        <div id="tab1" class="card">
            <div class="card-body">
                <asp:GridView ID="gvDtlsClient" runat="server" class="table table-hover table-bordered table-striped" AutoGenerateColumns="False"
                    EmptyDataText="No data found." DataKeyNames="DTLS_CLIENT_KEY" Width="100%">
                    <Columns>
                        ...
                        <asp:BoundField DataField="CLIENT_TYPE" HeaderText="Client Type">
        ...
        <div id="tab2" class="card" style="display: none">
            <div>
                <asp:HiddenField ID="hf_CLIENT_IMG" runat="server" Value="" />
                <asp:HiddenField ID="hf_DTLS_CLIENT_KEY" runat="server" Value="0" />
            </div>
            <div class="card">
                <div class="card-body">
                    <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>
                                                Client Name</label>
                                            <asp:TextBox ID="txt_CLIENT_NAME" class="form-control" runat="server"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>
                                                Client Type</label>
                                            <asp:TextBox ID="txt_CLIENT_TYPE" class="form-control" runat="server"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txt_CLIENT_DESC" TextMode="MultiLine" class="form-control" runat="server"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <asp:FileUpload ID="fu_Client" runat="server" class="form-input-styled" data-fouc accept=".gif, .png, .jpg, .jpeg" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-8 ml-auto mr-auto">
                                                <img id="img_Client" src="../admin/assets/images/no_image.jpg" class="form-control preview" runat="server" />
                                            </div>
                                        </div>
                                    </fieldset>
                                </div>
...
<asp:Content ID="Content4" ContentPlaceHolderID="cph_Scripts" runat="server">
    <script type="text/javascript">
        ...
        function OpenTab1(strMsg, error) {
            ...
            $("#tab3").hide();
            $("#tab2").hide();
            setDatatable("<%=gvDtlsClient.ClientID %>");
            if ($.trim(strMsg) != '') {
                if (error == 1)
        ...
        $(document).ready(function () {
            ...
            $("#<%=fu_Client.ClientID %>").on("change", function (evt) {
                var tgt = evt.target || window.event.srcElement, files = tgt.files;
                if (files.length > 0) {
                    if (files[0].size > 20097134) {
                        $(this).val("");
                        $(this).next(".filename").text("No file selected");
                        $('#<%=img_Client.ClientID %>').attr("src", "<%= Page.ResolveClientUrl("~/admin/assets/images/no_image.jpg")%>");
                        $(this).focus();
                        openErrorPopup("Please maintain allowed document size (20MB maximum).");
                    }
                    else {
                        readURL(this, $('#<%=img_Client.ClientID %>'));
                    }
                }
                else {
                    $('#<%=img_Client.ClientID %>').attr("src", "<%= Page.ResolveClientUrl("~/admin/assets/images/no_image.jpg")%>");
