...
<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="voting.aspx.cs"
    EnableEventValidation="false" ValidateRequest="false" Inherits="ProjectOne.admin.master.voting" %>
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="row">
                                            <div class="col-md-8 ml-auto mr-auto">
                                                <img id="img_Voting" src="../admin/assets/images/no_image.jpg" class="form-control preview" runat="server" />
                                            </div>
                                        </div>
                                    </fieldset>
                                </div>
            ...
            $("#<%=fu_Voting.ClientID %>").on("change", function (evt) {
                ...
                if (files.length > 0) {
                    if (files[0].size > 20097134) {
                        ...
                        $('#<%=img_Voting.ClientID %>').attr("src", "<%= Page.ResolveClientUrl("~/admin/assets/images/no_image.jpg")%>");
                        $(this).focus();
