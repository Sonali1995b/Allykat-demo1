...
namespace ProjectNine.admin.master
{
    public partial class appointment : System.Web.UI.Page
    {
        ...
        private String FillAppointmentGrid()
        {
            try
            {
                ...
                {
                    dt = oBMC.Get<Int32>("GET_APPOINTMENT", 1, "", ref errMsg, "2019", 1);
        ...
        protected void btn_View_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (Page.IsValid)
                {
                    ...
                    using (BALDtlsAppointment oBMC = new BALDtlsAppointment())
                    {
                        dt = oBMC.GetData<Int32>("GET_APPOINTMENT_ID", 1, oBMAST.DTLS_APPOINTMENT_KEY, ref errMsg, "2019", 1);
                        System.Threading.Thread.CurrentThread.CurrentCulture = new System.Globalization.CultureInfo("en-GB");
                    ...
                    if (timespan != "")
                    {
                        using (BALDtlsAppointment oBMC = new BALDtlsAppointment())
                        {
                            dt1 = oBMC.GetSlots<Int32>("GET_TIMESLOT", 1, timespan, ref errMsg, "2019", 1);
                            System.Threading.Thread.CurrentThread.CurrentCulture = new System.Globalization.CultureInfo("en-GB");
                            string JSONresult;
