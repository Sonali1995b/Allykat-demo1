<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="diary.aspx.cs" Inherits="ProjectOne.admin.master.diary"
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_FormName" runat="server">
    <i class="icon-home2 mr-2"></i>Diary
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="cph_MainBody" runat="server">
    <div>
        <asp:HiddenField ID="hf_DTLS_DIARY_KEY" runat="server" Value="0" />
        ...
        <div id="tab1" class="card">
            <div class="card-body">
                <asp:GridView ID="gvDtlsDiary" runat="server" class="table table-hover table-bordered table-striped" AutoGenerateColumns="False"
                    EmptyDataText="No data found." DataKeyNames="DTLS_DIARY_KEY" Width="100%">
                    <Columns>
                        ...
                        <asp:BoundField DataField="DIARY_HEADING" HeaderText="Heading">
        ...
        <div id="tab2" class="card" style="display: none">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="col-md-12">
                        <fieldset>
                            <legend class="font-weight-semibold">Dairy Details</legend>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>
                                                Short Desc</label>
                                            <asp:TextBox ID="txt_SHORT_DESC" TextMode="multiline" Rows="2" runat="server" class="form-control"></asp:TextBox>
                                        </div>
                                    </div>
									<div class="col-md-12">
										<div class="form-group">
