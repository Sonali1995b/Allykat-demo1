<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="news.aspx.cs"
    EnableEventValidation="false" ValidateRequest="false" Inherits="ProjectOne.admin.master.news" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_FormName" runat="server">
    <i class="icon-home2 mr-2"></i>News Page
</asp:Content>
        ...
        <div id="tab1" class="card">
            <div class="card-body">
                <asp:GridView ID="gvDtlsNews" runat="server" class="table table-hover table-bordered table-striped" AutoGenerateColumns="False"
                    EmptyDataText="No data found." DataKeyNames="DTLS_NEWS_KEY" Width="100%">
                    <Columns>
                        ...
                        <asp:BoundField DataField="NEWS_HEADING" HeaderText="News Heading">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txt_SHORT_DESC" TextMode="MultiLine" class="form-control" runat="server"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txt_NEWS_DESC" CssClass="summernote" TextMode="MultiLine" Rows="2" runat="server"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </fieldset>
...
<asp:Content ID="Content4" ContentPlaceHolderID="cph_Scripts" runat="server">
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#<%=txt_NEWS_DESC.ClientID %>").summernote({
                height: 180,
                codemirror: { "theme": "ambiance" }
            });

            $("#<%=txt_NEWS_DESC.ClientID %>").on('summernote.blur', function () {
                $("#<%=txt_NEWS_DESC.ClientID %>").html($("#<%=txt_NEWS_DESC.ClientID %>").summernote('code'));
            });
            ...
            $("#<%=fu_News.ClientID %>").on("change", function (evt) {
                ...
                if (files.length > 0) {
                    if (files[0].size > 20097134) {
                        ...
                        $('#<%=img_News.ClientID %>').attr("src", "<%= Page.ResolveClientUrl("~/admin/assets/images/no_image.jpg")%>");
                        $(this).focus();
