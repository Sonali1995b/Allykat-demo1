<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="homesettings.aspx.cs" Inherits="ProjectOne.admin.settings.homesettings"
            ...
            <div class="col-md-12">
                <fieldset>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <fieldset>
                                <legend>Upload About Us Picture.</legend>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>
                                                About Us Picture (Accepted Format .png, .jpg, .jpeg only. Max size 20 MB)
                                            </label>
...
<%--                        <div class="col-md-6">
                            <fieldset>
                                ...
                                <div class="row">
                                    <div class="col-md-10">
                                        <div class="form-group">
                                            <asp:FileUpload ID="fu_Offer" runat="server" class="form-input-styled" data-fouc accept=".gif, .png, .jpg, .jpeg, .webp, .bmp" />
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <input type="button" id="Offer_View" class="btn btn-primary form-control" value="View" />
                                        </div>
                                    </div>
                                </div>
                            </fieldset>
                        ...
                        <div class="col-md-6">
                            <fieldset>
                                ...
                                <div class="row">
                                    <div class="col-md-10">
                                        <div class="form-group">
                                            <asp:FileUpload ID="fu_About" runat="server" class="form-input-styled" data-fouc accept=".gif, .png, .jpg, .jpeg, .webp, .bmp" />
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <input type="button" id="About_View" class="btn btn-primary form-control" value="View" />
                                        </div>
                                    </div>
                                </div>
                            </fieldset>
