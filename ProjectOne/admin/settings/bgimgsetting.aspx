<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="bgimgsetting.aspx.cs" Inherits="ProjectOne.admin.settings.bgimgsetting" %>
                ...
                <fieldset>
                            ...
                            <fieldset>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>
                                                News & Announcements Background Picture (Accepted Format .png, .jpg, .jpeg only. Max size 20 MB)
                                            </label>
                    ...
                    <div class="row">
                         ...
                         <div class="col-md-4" style="display:none;">
                          ...
                          <div class="col-md-4">
                            <fieldset>
                                <legend>Upload Forum Background Picture.</legend>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>
                                                Forum Background Picture (Accepted Format .png, .jpg, .jpeg only. Max size 20 MB)
                                            </label>
            ...
            $("#<%=fu_Forum.ClientID %>").on("change", function (evt) {
                ...
                if (files.length > 0) {
                    if (files[0].size > 20097134) {
                        $(this).val("");
                        $(this).next(".filename").text("No file selected");
                        $('#<%=img_Forum.ClientID %>').attr("src", "<%= Page.ResolveClientUrl("~/assets/images/no_image.jpg")%>");
                        $(this).focus();
                        openErrorPopup("Please maintain allowed document size (20MB maximum).");
                    }
                    else {
