<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="forgotpassword.aspx.cs" Inherits="ProjectOne.user.forgotpassword" %>
   ...
   <html class="no-js lt-ie9 lt-ie8">
    ...
    <script>
        function popup() {
            swal({
                title: "Successful!",
                text: "Your email is submitted. Thank you for contacting us.Please Check Your Email.",
                icon: "success",
                button: "Ok",
            });
        }
                              ...
                              <div class="col-sm-12">
                                 <article class="post format-small-image with_background">
                                       ...
                                       <div class="row">
                                          <div class="col-md-6">
                                             <div class="item-media entry-thumbnail">
                                                <img src="" runat="server" id="forgot_img" alt="Allykat" title="Allykat">
                                             </div>
                                          </div>
                                          <div class="col-md-6">
                                              <h2 style="text-align: center;">
                                                   <span class="big">Forgot Password!!</span>
                                                </h2>
                                  ...
                                  <div class="text-center" >    
                                                <label class="text-label" for="email_2">Enter Your Phone Number :</label>
                                            <div class="text-center">
                                                <%--<input id="email_2" type="email" required class="form-control form-control-prepended" placeholder="john@doe.com">--%>
                                                 <asp:TextBox ID="txt_User_Email" required="required"  class="form-control form-control-prepended" placeholder="Enter Registered Phone" autocomplete="off" runat="server"></asp:TextBox>
