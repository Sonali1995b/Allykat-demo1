<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="resetpassword.aspx.cs" Inherits="ProjectOne.user.resetpassword" %>
         ...
         <section class="ds section_padding_70 about-content customheight-90">
                                       ...
                                       <div class="row">
                                          <div class="col-md-6">
                                             <div class="item-media entry-thumbnail">
                                                <img src="" runat="server" id="reset_img" alt="Allykat" title="Allykat">
                                             </div>
                                          </div>
                                          <div class="col-md-6">
                                              <h2 style="text-align: center;">
                                                   <span class="big">Reset Password</span>
                                                </h2>

                                           <form id="form1" runat="server" class="resetpass">
                 ...
                 <div class="form-group">
                    ...
                    <div class="text-center">
                        ...
                        <asp:TextBox ID="txt_NPassword" runat="server" TextMode="Password"  required="required" class="form-control form-control-prepended" placeholder="Enter New password" autocomplete="off"></asp:TextBox>
                        ...
                        <div class="input-group-prepend">
                            <div class="input-group-text">
                               ...
                               <div class="form-group">
                                    ...
                                    <div class="text-center">
                                        <%--<input id="password_2" type="password" required class="form-control form-control-prepended" placeholder="Enter your password">--%>
                                        <asp:TextBox ID="txt_CPassword" runat="server" TextMode="Password"  required="required" class="form-control form-control-prepended" placeholder="Confirm password" autocomplete="off"></asp:TextBox>
                                        <span id="show_password1" class="fa fa-eye-slash icon"></span>
                                        <div class="input-group-prepend">
                                            <div class="input-group-text">
                                ...
                                <div class="form-group text-center">
                                    <%--<button class="btn btn-primary btn-lg btn-block mb-3" type="submit">Create Account</button>--%>
                                    <asp:Button ID="btn_submit" class="theme_button color1 bottommargin_0" runat="server" Text="Submit" OnClick="btn_submit_Click" />
                                   <a href="login.aspx" class="theme_button color1 bottommargin_0" runat="server" >Back to Login</a>
                                </div>
                                           ...
                                           <%--<br />    
                                              <div class="text-center" >    
                                           <%-- <button type="submit" runat="server" class="theme_button color1 bottommargin_0" >Login</button>
                                                     <a  class="theme_button color1 bottommargin_0" runat="server" onserverclick="btn_submit_Click">Submit</a>
                                            </div>--%>
                                             <%--<a href="<%= Page.ResolveClientUrl("~/user/registration.aspx")%>" class="theme_button color1 bottommargin_0">Register</a>--%>
                  ...
                  <p class="darklinks">&copy; Ally Kat 2020, All Right Reserved.
     ...
     <script type="text/javascript">  
         $(document).ready(function () {
             $('#show_password').hover(function show() {
                 ...
                 $('#txt_NPassword').attr('type', 'text');
                 $('.icon').removeClass('fa fa-eye-slash').addClass('fa fa-eye');
             },
                 function () {
                     //Change the attribute back to password  
                     $('#txt_NPassword').attr('type', 'password');
     ...
     <script type="text/javascript">  
         $(document).ready(function () {
             $('#show_password1').hover(function show() {
                 //Change the attribute to text  
                 $('#txt_CPassword').attr('type', 'text');
                 $('.icon').removeClass('fa fa-eye-slash').addClass('fa fa-eye');
             },
                 function () {
                     //Change the attribute back to password  
                     $('#txt_CPassword').attr('type', 'password');
                     $('.icon').removeClass('fa fa-eye').addClass('fa fa-eye-slash');
                 });
             //CheckBox Show Password  
             $('#ShowPassword').click(function () {
