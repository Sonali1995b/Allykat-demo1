<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" EnableEventValidation="false" ValidateRequest="false" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="ProjectOne.news_details.index" %>
    ...
    <section class="ds section_padding_70 columns_padding_25">
                        <div class="container">
                           <div class="row">
                                ...
                                <h2><span class="big">News Details</span></h2>
                                </div>
                              <div class="col-sm-7 col-md-8 col-lg-8">
                                 <article>
                                 <div  id="news_img" runat="server">
                                ...
                                <div id="news_details" runat="server">
                                    ...
                                    <!-- .entry-header -->
                                    <div class="entry-content" id="news_desc" runat="server">
                              ...
                              <aside class="col-sm-5 col-md-4 col-lg-4">
                                 ...
                                 <div class="with_background with_padding">
                                    ...
                                    <div class="widget widget_popular_entries">
                                     ...
                                     <div id="news_desc1" runat="server">
