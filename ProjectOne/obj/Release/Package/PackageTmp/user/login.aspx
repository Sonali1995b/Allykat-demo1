<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="ProjectOne.user.login" %>
...
<html class="no-js lt-ie9 lt-ie8 lt-ie7">
   ...
   <html class="no-js lt-ie9 lt-ie8">
    ...
    <script>
        ...
        function popupinvaid() {
            swal({
                title: "Error!",
                text: "Wrong Credential!! Please enter registered phone and password.",
                icon: "error",
                button: "Ok",
            });
        }
                                       ...
                                       <div class="row">
                                          <div class="col-md-6">
                                             <div class="item-media entry-thumbnail">
                                                <img src="" runat="server" id="login_img" alt="Allykat" title="Allykat">
                                             </div>
                                          </div>
                                          <div class="col-md-6">
                                           ...
                                           <form id="login_list" runat="server">
                                            
                                             <div class="form-group">
                                                <label for="phone" class="sr-only">Phone Number
                                                <span class="required">*</span>
                                                </label>
                                                <input type="text" aria-required="true" runat="server" size="30" value="" name="phone" id="txt_Email" class="form-control text-center" placeholder="Registered Phone">
                                             </div>
                                             ...
                                             <asp:TextBox ID="txtPassword" TextMode="Password" class="form-control text-center" placeholder="Password" runat="server" required="required"></asp:TextBox>
                                               <span id="show_password" class="fa fa-eye-slash icon"></span>
                                                   <br />
                                             <a href="forgotpassword.aspx">Forget Password?</a><br><br>

                                            <button type="submit" runat="server" onserverclick="btn_login_Click" class="theme_button color1 bottommargin_0">Login</button>
