<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="useractivation.aspx.cs" Inherits="ProjectOne.user.useractivation" %>
                                       ...
                                       <div class="row">
                                          <div class="col-md-6">
                                             <div class="item-media entry-thumbnail">
                                                <img src="" runat="server" id="active_img" alt="Allykat" title="Allykat">
                                             </div>
                                          </div>
                                          <div class="col-md-6">
                                              <h2 style="text-align: center;">
                                                   <span class="big">User Activation</span>
                                                </h2>

                                           <form id="form1" runat="server">
                                              <asp:HiddenField ID="hf_USER_KEY" Value="0" runat="server" />
                                             <div  id="otp_div" runat="server">
                                              <div class="form-group">
                                                <label for="email" class="sr-only">Enter OTP
                                                <span class="required">*</span>
                                                </label>
                                                <input type="text" aria-required="true" runat="server" size="30" value="" name="email" id="txt_OTP" class="form-control text-center" placeholder="Enter OTP">
                                             </div>
                                              <div class="text-center">
                                            <button type="submit" runat="server" onserverclick="btn_verify_Click"  class="theme_button color1 bottommargin_0">Verify OTP</button> <%--onserverclick="btn_login_Click"--%>
                                               <button type="submit" runat="server" onserverclick="btn_resend_Click"  class="theme_button color1 bottommargin_0">Resend OTP</button>
                                                <%-- <a href="<%= Page.ResolveClientUrl("~/user/registration.aspx")%>" class="theme_button color1 bottommargin_0">Register</a>--%>
                                            </div>
                                              </div>
                                               <br />
                                               <div class="clearfix text-center" id="div_Activation_Msg" runat="server"></div>
                                             <br />
                                                 <div class="text-center" >
                                            <button type="submit" id="btnlogin" runat="server" onserverclick="btn_login_Click"  class="theme_button color1 bottommargin_0" >Login</button>
                                                     <%--<a href="login.aspx" class="theme_button color1 bottommargin_0">Login</a>--%>
                                            </div>
                                             <%--<a href="<%= Page.ResolveClientUrl("~/user/registration.aspx")%>" class="theme_button color1 bottommargin_0">Register</a>--%>
