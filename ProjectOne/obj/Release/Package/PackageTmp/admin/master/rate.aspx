<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="rate.aspx.cs"
    EnableEventValidation="false" ValidateRequest="false" Inherits="ProjectOne.admin.master.rate" %>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txt_ADD_HOURS" class="form-control" runat="server"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <fieldset>
                                        ...
                                        <div class="row">
                                            <div class="col-md-8 ml-auto mr-auto">
                                                <img id="img_Rate" src="../admin/assets/images/no_image.jpg" class="form-control preview" runat="server" />
                                            </div>
                                        </div>
                                    </fieldset>
                                </div>
            ...
            $("#<%=fu_Rate.ClientID %>").on("change", function (evt) {
                ...
                if (files.length > 0) {
                    if (files[0].size > 20097134) {
                        ...
                        $('#<%=img_Rate.ClientID %>').attr("src", "<%= Page.ResolveClientUrl("~/admin/assets/images/no_image.jpg")%>");
                        $(this).focus();
