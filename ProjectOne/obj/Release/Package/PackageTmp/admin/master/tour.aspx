<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="tour.aspx.cs"
    EnableEventValidation="false" ValidateRequest="false" Inherits="ProjectOne.admin.master.tour" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_FormName" runat="server">
    <i class="icon-home2 mr-2"></i>Tour Page
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="cph_MainBody" runat="server">
    <div class="content" style="min-height: 10px;">
        ...
        <div id="tab1" class="card">
            <div class="card-body">
                <asp:GridView ID="gvDtlsTour" runat="server" class="table table-hover table-bordered table-striped" AutoGenerateColumns="False"
                    EmptyDataText="No data found." DataKeyNames="DTLS_TOUR_KEY" Width="100%">
                    <Columns>
        ...
        <div id="tab2" class="card" style="display: none">
            <div>
                ...
                <asp:HiddenField ID="hf_DTLS_TOUR_KEY" runat="server" Value="0" />
            </div>
            <div class="card">
                <div class="card-body">
                    <div class="col-md-12">
                        <fieldset>
                            <legend class="font-weight-semibold">Tour Section</legend>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>
                                                Tour Place</label>
                                            <asp:TextBox ID="txt_TOUR_PLACE" class="form-control" runat="server"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>
                                                Start Date</label>
                                            <asp:TextBox ID="txt_START_DATE" class="form-control" runat="server"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>
                                                End Date</label>
                                            <asp:TextBox ID="txt_END_DATE" class="form-control" runat="server"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <fieldset>
                                        <legend>Tour Image</legend>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label>
...
<asp:Content ID="Content4" ContentPlaceHolderID="cph_Scripts" runat="server">
    <script type="text/javascript">
        ...
        function OpenTab1(strMsg, error) {
            ...
            $("#tab3").hide();
            $("#tab2").hide();
            setDatatable("<%=gvDtlsTour.ClientID %>");
            if ($.trim(strMsg) != '') {
                if (error == 1)
