<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" validateRequest="false" CodeBehind="prefer.aspx.cs" Inherits="ProjectOne.admin.master.prefer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_FormName" runat="server">
    <i class="icon-home2 mr-2"></i>Prefer Details
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="cph_MainBody" runat="server">
    ...
    <div>
        ...
        <asp:HiddenField ID="hf_DTLS_PREFER_KEY" runat="server" Value="0" />
    </div>
    <div class="content" style="min-height: 10px;">
        ...
        <div id="tab1" class="card">
            <div class="card-body">
                <asp:GridView ID="gvDTLSPrefer" runat="server" class="table table-hover table-bordered table-striped" AutoGenerateColumns="False"
                    EmptyDataText="No data found." DataKeyNames=" DTLS_PREFER_KEY" Width="100%">
                    <Columns>
                        ...
                        <asp:BoundField DataField="PREFER_NAME" HeaderText="Prefer Name">
        ...
        <div id="tab2" class="card" style="display: none">
            <div class="card">
                <div class="card-body">
                    <div class="col-md-12">
                        <fieldset>
                            <legend class="font-weight-semibold">Prefer Details</legend>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>
                                                Prefer Name</label>
                                            <asp:TextBox ID="txt_PREFER_NAME" class="form-control" runat="server"></asp:TextBox>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <fieldset>
                                        <legend>Prefer Details</legend>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label>
                                                        Upload Prefer Image (Accepted Format .png, .jpg, .jpeg only. Max size 2 MB)
                                                    </label>
...
<asp:Content ID="Content4" ContentPlaceHolderID="cph_Scripts" runat="server">
    <script type="text/javascript">
        ...
        function OpenTab1(strMsg, error) {
            ...
            $("#tab3").hide();
            $("#tab2").hide();
            setDatatable("<%=gvDTLSPrefer.ClientID %>");
            if ($.trim(strMsg) != '') {
                if (error == 1)
            ...
            $("#<%=fu_Prefer.ClientID %>").on("change", function (evt) {
                ...
                if (files.length > 0) {
                    if (files[0].size > 20097134) {
                        ...
                        $('#<%=img_Prefer.ClientID %>').attr("src", "<%= Page.ResolveClientUrl("~/admin/assets/images/no_image.jpg")%>");
                        $(this).focus();
